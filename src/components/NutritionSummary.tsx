  ...
  return (
    <Card className="h-full">
      <CardHeader className="pb-2">
        <CardTitle className="text-base dark:text-slate-300">
          Nutrition Summary
        </CardTitle>
      </CardHeader>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
          ...
          <div className="text-center">
            ...
            <div className="w-full bg-gray-200 rounded-full h-1.5 mt-1">
              <div
                ...
                style={{
                  width: `${Math.min((dayTotals.fat / goals.fat) * 100, 100)}%`,
                }}
              />
            </div>
          </div>
          <div className="text-center">
            <div className="text-lg sm:text-xl font-bold text-green-600">
              {dayTotals.dietary_fiber.toFixed(1)}g
            </div>
            <div className="text-xs text-gray-500">
              of {goals.dietary_fiber}g fiber
            </div>
            <div className="w-full bg-gray-200 rounded-full h-1.5 mt-1">
              <div
                className="bg-green-500 h-1.5 rounded-full"
                style={{
                  width: `${Math.min((dayTotals.dietary_fiber / goals.dietary_fiber) * 100, 100)}%`,
                }}
              />
            </div>
          </div>
