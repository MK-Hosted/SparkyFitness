...
import { ClipboardCopy, Info, Lock } from 'lucide-react';
...
const AuthenticationSettings: React.FC = () => {
  ...
  return (
    <Accordion type="multiple" className="w-full mx-auto space-y-6">
      ...
      <AccordionItem value="oidc-provider-settings" className="border rounded-lg">
        <AccordionTrigger
          className="flex items-center gap-2 p-4 hover:no-underline"
          description="Configure your OpenID Connect (OIDC) provider settings."
        >
